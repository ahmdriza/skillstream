...
import { Avatar, LinearProgress, Chip, Box } from '@mui/material';
                    ...
                    <div className="p-4 flex flex-col gap-4">
                        ...
                        {instructor && (
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-small text-gray-500">{instructor.name}</span>
                            </div>
                        )}
                        ...
                        <Button
                            ...
                            className="font-medium mt-2 w-full"
                        >
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex w-full flex-col">
                <Tabs aria-label="Course Filters">
                    ...
                    <Tab key="recorded" title={`Recorded (${recordedCourses.length})`}>
                        <div className="mt-4">
                            {recordedCourses.length > 0 ? (
                                ...
                                <Card className="p-8 text-center" shadow="sm">
                                    <p className="text-gray-500">No recorded courses enrolled</p>
                                </Card>
                            )}
                        </div>
                    </Tab>
                    <Tab key="live" title={`Live (${liveCourses.length})`}>
                        <div className="mt-4">
                            {liveCourses.length > 0 ? (
                                ...
                                <Card className="p-8 text-center" shadow="sm">
                                    <p className="text-gray-500">No live courses enrolled</p>
                                </Card>
                            )}
                        </div>
                    </Tab>
